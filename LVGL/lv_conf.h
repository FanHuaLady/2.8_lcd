...
/*交换 RGB565 颜色中的 2 个字节。如果显示设备具有 8 位接口（例如 SPI 接口），则此操作很有用。*/
#define LV_COLOR_16_SWAP 1																								// 此处改为1
...
/*默认显示刷新周期。LVG 将在该时间段内重新绘制发生变化的区域。*/
...
/*默认每英寸点数。用于初始化默认尺寸，例如控件的大小、样式边距等。.
 *(Not so important, you can adjust it to modify default sizes and spaces)*/
#define LV_DPI_DEF 80     /*[px/inch]*/																					//
